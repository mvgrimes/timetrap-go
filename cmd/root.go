...
func init() {
	...
	viper.BindPFlag("round", nowCmd.PersistentFlags().Lookup("round"))
	viper.BindPFlag("yes", nowCmd.PersistentFlags().Lookup("yes"))
	viper.BindPFlag("debug", nowCmd.PersistentFlags().Lookup("debug"))
}
